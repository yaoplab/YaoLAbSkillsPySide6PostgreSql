...
class LoginWindow(QMainWindow):
    ...
    def _STYLE(self) -> str:
        ...
        return f"""
            ...
            QLineEdit {{
                padding: {ds.space_xs + ds.space_xxs // 2}px {ds.space_sm + ds.space_xxs // 2}px;  # 10px 14px
                border: 1px solid {p.border};
            ...
            QPushButton.btn-primary {{
                ...
                border: none;
                border-radius: {ds.radius_sm}px;  # 8px
                padding: {ds.space_xs + ds.space_xxs // 2}px {ds.table_row_min}px;  # 10px 21px
                font-size: {fs(13)}px;
                font-weight: bold;
            }}
            ...
            QPushButton.btn-secondary {{
                ...
                border: 1px solid {p.border};
                border-radius: {ds.radius_sm}px;  # 8px (6 INTERDIT)
                padding: {ds.space_xs}px {ds.font_label_lg}px;  # 8px 13px (6 INTERDIT)
                font-size: {fs(11)}px;
            }}
            ...
            QPushButton.btn-browse {{
                ...
                font-size: {fs(11)}px;
                font-weight: bold;
                min-width: {theme_manager.image.theme_btn}px;  # 34px
            }}
            ...
            QTabBar::tab {{
                padding: {ds.space_xs}px {ds.space_sm + ds.space_xxs}px;  # 8px 16px
                font-size: {fs(11)}px;
            }}
    ...
    def _setup_ui(self) -> None:
        ...
        self._net_txt.setStyleSheet(f"font-size: {theme_manager.font_size(11)}px; color: {p.text_strong};")
        self._net_txt.setContentsMargins(sp(SpacingToken.SM), 0, 0, 0)
    ...
    def _build_header(self) -> QWidget:
        ...
        text_col.setSpacing(sp(SpacingToken.XXS))
