...
1. Lire [graphify](../skills/graphify/SKILL.md), [database-operations](../skills/database-operations/SKILL.md) et [sync](../skills/sync/SKILL.md)
2. Verifier le graphe de connaissances (fraicheur, god nodes, completude)
3. Verifier les connexions PostgreSQL
4. Lancer les linters
5. Tester la synchronisation (si LarcCloudSync)
...
|---|---|---|
| Graphe de connaissances | [graphify](../skills/graphify/SKILL.md) | `graphify god-nodes --top 10` |
