...
from LarcDesign.common.db_access import get_locations
...
class LieuxPanel(M3ScrollArea):
    def __init__(self, user: dict):
        ...
        table.setHorizontalHeaderLabels(["ID", "Lieu", "Etablissement"])
        ...
        for i, r in enumerate(rows):
            ...
            table.setItem(i, 1, QTableWidgetItem(r.get('nom', '') or ''))
            table.setItem(i, 2, QTableWidgetItem(str(r.get('fk_etab', '')) or ''))
