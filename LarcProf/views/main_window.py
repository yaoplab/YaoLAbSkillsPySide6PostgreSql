...
class MainWindow(QMainWindow):
    ...
    def _build_header(self) -> QWidget:
        ...
        palette_btn.setFixedSize(ds.icon_btn_size, ds.icon_btn_size)
        ...
        palette_btn.setStyleSheet(
            ...
            f"border-radius: {ds.icon_btn_size // 2}px; font-size: {theme_manager.font_size(14)}px; color: {theme_manager.theme.palette.on_primary}; }}"
        ...
        font_btn.setFixedSize(ds.font_btn_width, ds.font_btn_height)
        font_btn.setToolTip('Taille du texte')
        font_btn.setStyleSheet(
            f"QPushButton {{ background: transparent; border: 1px solid {theme_manager.theme.palette.on_primary}; "
            f"border-radius: {ds.font_btn_height // 2}px; font-size: {theme_manager.font_size(11)}px; font-weight: bold; "
            f"color: {theme_manager.theme.palette.on_primary}; }}"
            f"QPushButton:hover {{ background: rgba(255,255,255,0.2); }}"
        )
        font_menu = QMenu()
    ...
    def _build_matiere_section(self) -> QFrame:
        ...
        f.setFixedWidth(ds.sidebar_width)
        v = QVBoxLayout(f)
    ...
    def _build_eval_section(self, eval_type: str) -> dict:
        ...
        gerer_btn.setFixedHeight(ds.table_row_min)
        ...
        gerer_btn.setStyleSheet(
            ...
            f"border-radius: {ds.font_label_lg}px; font-weight: bold; "
            f"padding: {ds.space_xxs // 2}px {ds.font_label_lg}px; }}"
            f"QPushButton:hover {{ background: {theme_manager.theme.palette.primary}; }}"
        )
        if is_f:
        ...
        scroll.setMaximumHeight(ds.scroll_max_height)
        ...
        slot_layout.setSpacing(ds.space_xxs)
        ...
        tout_btn.setFixedHeight(ds.table_row_min)
        ...
        aucune_btn.setFixedHeight(ds.table_row_min)
        ...
        comm_btn.setFixedHeight(ds.table_row_min)
    ...
    def _build_jugements_section(self) -> dict:
        ...
        f.setProperty('class', 'panel')
        f.setFrameShape(QFrame.StyledPanel)
        f.setFixedWidth(ds.jugements_width)
        v = QVBoxLayout(f)
        v.setContentsMargins(ds.space_xs, ds.space_xxs, ds.space_xs, ds.space_xxs)
        v.setSpacing(ds.space_xxs)
